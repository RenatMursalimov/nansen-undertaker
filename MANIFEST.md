...
| `docs/CATALOG.md` | `41930c6fa3d1741f` | from the bot, private paths/services substituted (see below) |
| `docs/CATALOG_ru.md` | `814c55ef0faa802e` | from the bot, private paths/services substituted (see below) |
...
| `docs/PROJECT_STATUS.md` | `fa8ca8f6882ac445` | from the bot, private paths/services substituted (see below) |
| `docs/RECORDING_RUNBOOK.md` | `f897c1d05a2244e0` | from the bot, private paths/services substituted (see below) |
| `docs/SENTINEL_SPEC.md` | `6b371d4742d09d52` | from the bot, private paths/services substituted (see below) |
| `docs/SENTINEL_SPEC_ru.md` | `45c38ee5619ade62` | from the bot, private paths/services substituted (see below) |
...
| `sentinel/cards.py` | `bf3719fd599564eb` | byte-for-byte from the bot |
| `sentinel/config.py` | `7562192eac5d73e3` | byte-for-byte from the bot |
| `sentinel/detector.py` | `332c6ba40bb74f2f` | byte-for-byte from the bot |
| `sentinel/engine.py` | `c4ccbb1ff1143c72` | byte-for-byte from the bot |
| `sentinel/enrichment.py` | `2168dcc051e83bda` | byte-for-byte from the bot |
| `sentinel/ignition.py` | `e4b6ee767f90e489` | byte-for-byte from the bot |
| `sentinel/main.py` | `85e90b6d558c0d49` | byte-for-byte from the bot |
| `sentinel/outbox.py` | `519a44292fca325b` | byte-for-byte from the bot |
| `sentinel/store.py` | `4eb2b62bdba7c466` | byte-for-byte from the bot |
| `sentinel/ui.py` | `e9651f3de6266cdb` | byte-for-byte from the bot |
| `sentinel/variational_feed.py` | `fefc9fd103e870b3` | byte-for-byte from the bot |
| `tests/test_public.py` | `221c07951d891077` | extract-only, this file does not exist in the bot |
| `tests/test_sentinel.py` | `d369fd50c1c1bf20` | byte-for-byte from the bot |
