...
| `docs/PROJECT_STATUS.md` | `08be666e7c9cc372` | from the bot, private paths/services substituted (see below) |
| `docs/RECORDING_RUNBOOK.md` | `f897c1d05a2244e0` | from the bot, private paths/services substituted (see below) |
| `docs/SENTINEL_SPEC.md` | `b7a081778221802e` | from the bot, private paths/services substituted (see below) |
| `docs/SENTINEL_SPEC_ru.md` | `bd97fcaddbc01be2` | from the bot, private paths/services substituted (see below) |
...
| `sentinel/cards.py` | `0daa443f7f632f1a` | byte-for-byte from the bot |
| `sentinel/config.py` | `67db610047f32833` | byte-for-byte from the bot |
| `sentinel/detector.py` | `26396fff0f7a7b10` | byte-for-byte from the bot |
| `sentinel/engine.py` | `6be92a678e32d82e` | byte-for-byte from the bot |
...
| `sentinel/lab.py` | `a5ddd07aaf4b23ca` | byte-for-byte from the bot |
| `sentinel/main.py` | `dec8eaf0afa12af4` | byte-for-byte from the bot |
| `sentinel/outbox.py` | `1d7748544a193c46` | byte-for-byte from the bot |
| `sentinel/store.py` | `21a4231760ab0fd7` | byte-for-byte from the bot |
...
| `tests/test_sentinel.py` | `930713a77eb66d0e` | byte-for-byte from the bot |
